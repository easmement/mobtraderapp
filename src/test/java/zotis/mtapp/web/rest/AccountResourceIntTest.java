package zotis.mtapp.web.rest;

import zotis.mtapp.MobtraderappApp;
import zotis.mtapp.config.Constants;
import zotis.mtapp.domain.Authority;
import zotis.mtapp.domain.User;
import zotis.mtapp.repository.AuthorityRepository;
import zotis.mtapp.repository.UserRepository;
import zotis.mtapp.security.AuthoritiesConstants;
import zotis.mtapp.service.MailService;
import zotis.mtapp.service.UserService;
import zotis.mtapp.service.dto.PasswordChangeDTO;
import zotis.mtapp.service.dto.UserDTO;
import zotis.mtapp.web.rest.errors.ExceptionTranslator;
import zotis.mtapp.web.rest.vm.KeyAndPasswordVM;
import zotis.mtapp.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = MobtraderappApp.class)

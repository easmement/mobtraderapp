package zotis.mtapp.repository;

import zotis.mtapp.MobtraderappApp;
import zotis.mtapp.config.Constants;
import zotis.mtapp.config.audit.AuditEventConverter;
import zotis.mtapp.domain.PersistentAuditEvent;
...
import static zotis.mtapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
